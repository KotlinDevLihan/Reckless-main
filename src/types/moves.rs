...
impl Move {
    ...
    pub const fn is_noisy(self) -> bool {
        let kind = (self.0 >> 12) as u8;
        (kind & 0b0100) != 0 || kind == MoveKind::PromotionQ as u8
    }

    pub const fn is_special(self) -> bool {
        ((self.0 >> 12) as u8 & 11) != 0
    }
    ...
    pub const fn is_en_passant(self) -> bool {
        ((self.0 >> 12) as u8) == MoveKind::EnPassant as u8
    }

    pub const fn is_castling(self) -> bool {
        ((self.0 >> 12) as u8) == MoveKind::Castling as u8
    }

    pub const fn is_double_push(self) -> bool {
        ((self.0 >> 12) as u8) == MoveKind::DoublePush as u8
    }

    pub const fn promo_piece_type(self) -> PieceType {
        debug_assert!(self.is_promotion());
        PieceType::new((((self.0 >> 12) as usize) & 3) + PieceType::Knight as usize)
    }
