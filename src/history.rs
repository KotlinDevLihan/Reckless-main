...
// Counter Move table: indexed by [piece][to_square] of opponent's move
// Stores the best reply move
pub struct CounterMoveTable {
    entries: Box<[[[Move; 64]; 13]; 2]>,
}
...
impl CounterMoveTable {
    ...
    pub fn get(&self, stm: Color, piece: Piece, to: Square) -> Move {
        self.entries[stm][piece][to]
    }

    pub fn update(&mut self, stm: Color, piece: Piece, to: Square, mv: Move) {
        self.entries[stm][piece][to] = mv;
    }
}
